...
public class AssistScorerAdapter extends RecyclerView.Adapter<AssistScorerAdapter.CardViewTasarimNesneleriniTutucu> {
    ...
    public AssistScorerAdapter(Context mContext, List<Footballer> footballers) {
    ...
    public class CardViewTasarimNesneleriniTutucu extends RecyclerView.ViewHolder {
        ...
        public CardViewTasarimNesneleriniTutucu(View view) {
            super(view);
            textViewTeamName = (TextView) view.findViewById(R.id.textViewTeamName);
    ...
    public CardViewTasarimNesneleriniTutucu onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_footballer_goals_assits, parent, false);
