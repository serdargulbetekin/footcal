...
public class DialogGoalAsistAdapter extends RecyclerView.Adapter<DialogGoalAsistAdapter.CardViewTasarimNesneleriniTutucu> {
    ...
    public DialogGoalAsistAdapter(Context mContext, List<Footballer> footballers) {
