...
import com.sgfootcal.android.footcal.Adapter.GoalScorerAdapterSpecial;
...
public class TopScorerFragmentSpecial extends Fragment implements SearchView.OnQueryTextListener{
    private RecyclerView recyclerView;
    private GoalScorerAdapterSpecial goalScorerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if (isOnline()) {
            ...
            getTheTopScorersOfTeam(Integer.parseInt(teams.getTeam_Id()));
    ...
    public boolean onQueryTextChange(String newText) {
        if (isOnline()) {
            allFootballerSearchByTeamIdTopScorers(newText, Integer.parseInt(teams.getTeam_Id()));
        }
        return false;
    }
    @Override
    ...
    public void getTheTopScorersOfTeam(int Team_Id){
        ...
        footballerDaoInterface.allFootballerByTeamIdTopScorer(Team_Id).enqueue(new Callback<FootballerSample>() {
            ...
            public void onResponse(Call<FootballerSample> call, Response<FootballerSample> response) {
                if (response.isSuccessful()){
                    ...
                    goalScorerAdapter = new GoalScorerAdapterSpecial(getContext(),footballerList);

                    recyclerView.setAdapter(goalScorerAdapter);
    ...
    public void allFootballerSearchByTeamIdTopScorers(final String searchKey,int Team_Id){

        footballerDaoInterface.allFootballerSearchByTeamIdTopScorers(searchKey,Team_Id).enqueue(new Callback<FootballerSample>() {
            @Override
            public void onResponse(Call<FootballerSample> call, Response<FootballerSample> response) {
                if (response.isSuccessful()){
                    List<Footballer> footballerList  = response.body().getFootballer();
