...
import com.sgfootcal.android.footcal.Adapter.AssistScorerAdapterSpecial;
...
public class AssistFragmentSpecial extends Fragment implements SearchView.OnQueryTextListener{
    private RecyclerView recyclerView;
    private AssistScorerAdapterSpecial assistScorerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if (isOnline()) {
            ...
            getAssistScorer(Integer.parseInt(teams.getTeam_Id()));
    ...
    public boolean onQueryTextChange(String newText) {
        if (isOnline()) {
            allFootballerSearchByTeamIdTopAssisters(newText, Integer.parseInt(teams.getTeam_Id()));
        }
        return false;
    }
    @Override
    ...
    public void getAssistScorer(int Team_Id){
        ...
        footballerDaoInterface.allFootballerByTeamIdTopAssistScorer(Team_Id).enqueue(new Callback<FootballerSample>() {
            ...
            public void onResponse(Call<FootballerSample> call, Response<FootballerSample> response) {
                if (response.isSuccessful()){
                    ...
                    assistScorerAdapter = new AssistScorerAdapterSpecial(getContext(),footballerList);
    ...
    public void allFootballerSearchByTeamIdTopAssisters(final String searchKey,int League_Id){

        footballerDaoInterface.allFootballerSearchByTeamIdTopAssisters(searchKey,League_Id).enqueue(new Callback<FootballerSample>() {
            @Override
            public void onResponse(Call<FootballerSample> call, Response<FootballerSample> response) {
                if (response.isSuccessful()){
                    List<Footballer> footballerList  = response.body().getFootballer();
